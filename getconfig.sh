...
# 11. Добавить домены Discord в список Zapret
...
# 12. Удалить старый конфиг (если он есть)
rm -rf /etc/sing-box/config.json

# 13. Запустить скрипт 40-getvpnconfig
